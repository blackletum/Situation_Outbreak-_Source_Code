...
// S:O - Additional External Functions
...
ConVar so_roundtime( "so_roundtime", "10.0", FCVAR_GAMEDLL, "Defines how long a round lasts");
...
/*//-----------------------------------------------------------------------------
// MOUNTING ADDITIONAL GAMES LINES		
//-----------------------------------------------------------------------------
...
bool CServerGameDLL::GameInit( void )
{
	...
	// S:O - Additional Initial Configuration
	engine->ServerCommand( "exec soconfig.cfg\n" );
...
bool CServerGameDLL::LevelInit( const char *pMapName, char const *pMapEntities, char const *pOldLevel, char const *pLandmarkName, bool loadGame, bool background )
{
	...
	// S:O - More Additional Initial Configuration
	engine->ServerCommand( "exec game.cfg\n" );
	engine->ServerCommand( "exec soconfig.cfg\n" );
	engine->ServerCommand( "sv_lan 0\n" );
	engine->ServerCommand( "heartbeat\n" );
	...
	if ( FStrEq(so_gamemode.GetString(), "Holdout") )
	{
...
void CServerGameClients::GetBugReportInfo( char *buf, int buflen )
{
	...
	{
		CBaseEntity *ent = FindPickerEntity( UTIL_GetLocalPlayer() ); // AI Patch Addition.
		if ( ent )
		{
