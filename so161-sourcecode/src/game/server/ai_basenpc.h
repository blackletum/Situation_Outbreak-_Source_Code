...
#define MAX_AIS	256 // AI Patch Addition.
...
public:
	...
	int AddAI( CAI_BaseNPC *pAI ); // AI Patch Addition.
...
public:
	...
	int	m_iOwner;
	int GetNPCSpawnID();
	bool m_bShouldSearchForRallyPoint;
	void SetNPCSpawnID( int ID );
	void FindRallyPoint();
...
private:
	...
	// S:O - Used to ID NPC kills for new "npc_death" event
	bool bNPCKill;
	bool bZombieNPCKill;
...
public:
	...
	static void			ConqCommanded(const Vector &targetPos, const Vector &traceDir, bool bRun, CAI_BaseNPC *npc);
	Vector				m_vecLastGoalPosition;
...
public:
	...
	// used by lag compensation to be able to refer to & track specific NPCs, and detect changes in the AI list // AI Patch Addition.
	void				SetAIIndex(int i) { m_iAIIndex = i; } // AI Patch Addition.
	int					GetAIIndex() { return m_iAIIndex; } // AI Patch Addition.
private: // AI Patch Addition.
	int					m_iAIIndex; // AI Patch Addition.
 };
