...
void FinishClientPutInServer( CHL2MP_Player *pPlayer )
{
	...
	{
		UTIL_HudHintText( pPlayer, "Welcome to Situation Outbreak!" );
	...
	else
	{
		UTIL_HudHintText( pPlayer, "Welcome to Situation Outbreak!" );
		ClientPrint( pPlayer, HUD_PRINTTALK, "Welcome to Situation Outbreak!\n" );
		ClientPrint( pPlayer, HUD_PRINTTALK, "You will spawn within 30 seconds.\n" );
	}
