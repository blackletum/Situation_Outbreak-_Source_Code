...
public:
	...
	// S:O - Initialize Global Lists
	CUtlVector<CBaseEntity *> m_SurvivorList;
	CUtlVector<CBaseEntity *> m_ZombieList;
	CUtlVector<CBaseEntity *> m_MilitaryList;
	CUtlVector<CBaseEntity *> m_PlayerList;
	CUtlVector<CBaseEntity *> m_EscapedList;
