...
void CBaseCombatCharacter::Weapon_Drop( CBaseCombatWeapon *pWeapon, const Vector *pvecTarget /* = NULL */, const Vector *pVelocity /* = NULL */ )
{
	...
	if( FClassnameIs( pWeapon, "weapon_zombie" ) || FClassnameIs( pWeapon, "weapon_charple" ) || FClassnameIs( pWeapon, "weapon_corpse" ) || FClassnameIs( pWeapon, "weapon_stalker" ) || FClassnameIs( pWeapon, "weapon_brassknuckles" ) )
	{
		return;
	}
	...
	if ( GetFlags() & FL_NPC )
	{
		if ( pWeapon->UsesClipsForAmmo1() )
		{
			...
			if( FClassnameIs( pWeapon, "weapon_smg1" ) )
			{
				...
				float flAmmoDamage = g_pGameRules->GetAmmoDamage( UTIL_GetNearestPlayer(GetAbsOrigin()), this, pWeapon->GetPrimaryAmmoType() ); // AI Patch Addition.
