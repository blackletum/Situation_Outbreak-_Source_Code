...
// helper functions added for replacing the above // AI Patch Addition.
CBasePlayer *UTIL_GetNearestPlayer( const Vector &origin ); // AI Patch Addition.
CBasePlayer *UTIL_GetNearestVisiblePlayer(CBaseEntity *pLooker, int mask = MASK_SOLID_BRUSHONLY); // AI Patch Addition.
