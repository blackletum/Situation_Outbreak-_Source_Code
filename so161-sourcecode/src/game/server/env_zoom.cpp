...
{
	CBasePlayer *pPlayer; // AI Patch Addition.
		
	if ( inputdata.pActivator && inputdata.pActivator->IsPlayer() ) // AI Patch Addition.
		pPlayer = ToBasePlayer( inputdata.pActivator ); // AI Patch Addition.
