...
class CBaseZMSStart : public CPointEntity
{
public:
	DECLARE_CLASS( CBaseZMSStart, CPointEntity );
		bool IsTriggered( CBaseEntity *pEntity );
	DECLARE_DATADESC();
...
BEGIN_DATADESC( CBaseZMSStart )
	DEFINE_KEYFIELD( m_Master, FIELD_STRING, "master" ),
END_DATADESC()

LINK_ENTITY_TO_CLASS( zms_spawnpoint, CBaseZMSStart );
LINK_ENTITY_TO_CLASS( so_spawnpoint, CBaseZMSStart );

bool CBaseZMSStart::IsTriggered( CBaseEntity *pEntity )
{
	bool master = UTIL_IsMasterTriggered( m_Master, pEntity );
	return master;
}
...
class CBaseSOExtSurvivorStart : public CPointEntity
{
public:
	DECLARE_CLASS( CBaseSOExtSurvivorStart, CPointEntity );
		bool IsTriggered( CBaseEntity *pEntity );
	DECLARE_DATADESC();
...
BEGIN_DATADESC( CBaseSOExtSurvivorStart )
	DEFINE_KEYFIELD( m_Master, FIELD_STRING, "master" ),
END_DATADESC()

LINK_ENTITY_TO_CLASS( so_ext_survivor_spawnpoint, CBaseSOExtSurvivorStart );

bool CBaseSOExtSurvivorStart::IsTriggered( CBaseEntity *pEntity )
{
	bool master = UTIL_IsMasterTriggered( m_Master, pEntity );
	return master;
}
...
class CBaseSOExtMilitaryStart : public CPointEntity
{
public:
	DECLARE_CLASS( CBaseSOExtMilitaryStart, CPointEntity );
		bool IsTriggered( CBaseEntity *pEntity );
	DECLARE_DATADESC();
...
BEGIN_DATADESC( CBaseSOExtMilitaryStart )
	DEFINE_KEYFIELD( m_Master, FIELD_STRING, "master" ),
END_DATADESC()

LINK_ENTITY_TO_CLASS( so_ext_military_spawnpoint, CBaseSOExtMilitaryStart );

bool CBaseSOExtMilitaryStart::IsTriggered( CBaseEntity *pEntity )
{
	bool master = UTIL_IsMasterTriggered( m_Master, pEntity );
	return master;
}
