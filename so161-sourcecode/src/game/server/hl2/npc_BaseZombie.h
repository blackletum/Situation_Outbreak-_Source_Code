...
enum 
{
	...
	TASK_ZOMBIE_GET_PATH_TO_HOLDOUT_TRIGGER,
...
//=========================================================
//=========================================================
class CNPC_BaseZombie : public CAI_BaseZombieBase
{
...
public:
	...
	// S:O - Used to ID entities that are zombies
	virtual bool IsZombie( void ) const { return true; }
	...
	void SwatObject( IPhysicsObject *pPhysObj, Vector direction );
...
protected:
	...
	// S:O - Defines how often we should check for doors.
	float	m_flDoorCheckTime;
	...
	float HoldoutTriggerAmbushDelay;
	float m_flMoanPitch;
