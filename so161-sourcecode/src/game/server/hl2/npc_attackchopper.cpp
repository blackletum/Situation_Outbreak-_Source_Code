...
void CNPC_AttackHelicopter::DropCorpse( int nDamage )
{
	...
	CBaseEntity *pGib = CreateRagGib( "models/Military/soldier.mdl", GetAbsOrigin(), GetAbsAngles(), vecForceVector );
	if ( pGib )
	{
...
bool CGrenadeHelicopter::IsThrownByPlayer()
{
	...
	return ( GetOwnerEntity()->IsPlayer() && m_bExplodeOnContact ); // AI Patch Addition.
}
