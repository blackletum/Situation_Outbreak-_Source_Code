...
#ifdef HL2MP
//#include "hl2mp/weapon_crowbar.h"	// S:O - We don't use this.
#else
...
extern ConVar so_survivor_health;

const int MAX_PLAYER_SQUAD = 4;

//ConVar	sk_survivor_health				( "sk_survivor_health",					"0");
...
// S:O - What is this? We don't need it.
...
{
	// Remove this survivor from our global survivor list!
	// NOTE: It's dead.
	gEntList.m_SurvivorList.FindAndRemove(this);
}
...
void CNPC_Citizen::Precache()
{
	...
	// S:O - Melee attack (fixed w/ damage and sounds)
...
void CNPC_Citizen::PrecacheAllOfType( CitizenType_t type )
{
	...
	PrecacheModel( "models/Humans/survivornpc1.mdl" );
	PrecacheModel( "models/Humans/survivornpc2.mdl" );
	PrecacheModel( "models/Humans/survivornpc3.mdl" );
	PrecacheModel( "models/Humans/survivornpc4.mdl" );
	PrecacheModel( "models/Humans/survivornpc5.mdl" );
	PrecacheModel( "models/Humans/survivornpc6.mdl" );
	PrecacheModel( "models/Humans/survivornpc7.mdl" );
	PrecacheModel( "models/Humans/survivornpc8.mdl" );
	PrecacheModel( "models/Humans/survivornpc9.mdl" );
	PrecacheModel( "models/Humans/survivornpc10.mdl" );
	PrecacheModel( "models/Humans/survivornpc11.mdl" );
	PrecacheModel( "models/Humans/survivornpc12.mdl" );
	PrecacheModel( "models/Humans/survivornpc13.mdl" );
	PrecacheModel( "models/Humans/survivornpc14.mdl" );
	PrecacheModel( "models/Humans/survivornpc15.mdl" );
	PrecacheModel( "models/Humans/survivornpc16.mdl" );
	PrecacheModel( "models/Humans/survivornpc17.mdl" );
	PrecacheModel( "models/Humans/survivornpc18.mdl" );
	PrecacheModel( "models/Humans/survivornpc19.mdl" );
	PrecacheModel( "models/Humans/survivornpc20.mdl" );
	PrecacheModel( "models/Humans/survivornpc21.mdl" );
	PrecacheModel( "models/Humans/survivornpc22.mdl" );
	PrecacheModel( "models/Humans/survivornpc23.mdl" );
	PrecacheModel( "models/Humans/survivornpc24.mdl" );
	PrecacheModel( "models/Humans/survivornpc25.mdl" );
	PrecacheModel( "models/Humans/survivornpc26.mdl" );
	PrecacheModel( "models/Humans/survivornpc27.mdl" );
}
...
void CNPC_Citizen::Spawn()
{
	...
	m_iHealth = so_survivor_health.GetFloat();
...
void CNPC_Citizen::SelectModel()
{
	...
	int randnpcc17 = RandomInt(1,27);
	switch ( randnpcc17 )
	{
		case 1:
			SetModel("models/Humans/survivornpc1.mdl"); 
			break;

		case 2:
			SetModel("models/Humans/survivornpc2.mdl"); 
			break;

		case 3:
			SetModel("models/Humans/survivornpc3.mdl"); 
			break;

		case 4:
			SetModel("models/Humans/survivornpc4.mdl"); 
			break;

		case 5:
			SetModel("models/Humans/survivornpc5.mdl"); 
			break;

		case 6:
			SetModel("models/Humans/survivornpc6.mdl"); 
			break;

		case 7:
			SetModel("models/Humans/survivornpc7.mdl"); 
			break;

		case 8:
			SetModel("models/Humans/survivornpc8.mdl"); 
			break;

		case 9:
			SetModel("models/Humans/survivornpc9.mdl"); 
			break;

		case 10:
			SetModel("models/Humans/survivornpc10.mdl"); 
			break;

		case 11:
			SetModel("models/Humans/survivornpc11.mdl"); 
			break;

		case 12:
			SetModel("models/Humans/survivornpc12.mdl"); 
			break;

		case 13:
			SetModel("models/Humans/survivornpc13.mdl"); 
			break;

		case 14:
			SetModel("models/Humans/survivornpc14.mdl"); 
			break;

		case 15:
			SetModel("models/Humans/survivornpc15.mdl"); 
			break;

		case 16:
			SetModel("models/Humans/survivornpc16.mdl"); 
			break;

		case 17:
			SetModel("models/Humans/survivornpc17.mdl"); 
			break;

		case 18:
			SetModel("models/Humans/survivornpc18.mdl"); 
			break;

		case 19:
			SetModel("models/Humans/survivornpc19.mdl"); 
			break;

		case 20:
			SetModel("models/Humans/survivornpc20.mdl"); 
			break;

		case 21:
			SetModel("models/Humans/survivornpc21.mdl"); 
			break;

		case 22:
			SetModel("models/Humans/survivornpc22.mdl"); 
			break;

		case 23:
			SetModel("models/Humans/survivornpc23.mdl"); 
			break;

		case 24:
			SetModel("models/Humans/survivornpc24.mdl"); 
			break;

		case 25:
			SetModel("models/Humans/survivornpc25.mdl"); 
			break;

		case 26:
			SetModel("models/Humans/survivornpc26.mdl"); 
			break;

		case 27:
			SetModel("models/Humans/survivornpc27.mdl"); 
			break;
	}
}
...
{
	BaseClass::Activate();
	//FixupMattWeapon();	// S:O - What is this? We don't need it.
}
...
Class_T	CNPC_Citizen::Classify()
{
	...
	// S:O - Altered according to new class definitions.
	return CLASS_PLAYER;
}
...
int CNPC_Citizen::SelectScheduleNonCombat()
{
	...
	if ( m_NPCState == NPC_STATE_IDLE || NPC_STATE_ALERT )
	{
		/*
		int RandomSched;
		RandomSched = random->RandomInt(1,5);
...
{
	// S:O - Melee fix (does damage now like combine ... this is also stolen from combine files lawl)
	if ( pEvent->event == ACT_MELEE_ATTACK1 || ACT_MELEE_ATTACK2 || ACT_GESTURE_MELEE_ATTACK1 || ACT_GESTURE_MELEE_ATTACK2 || ACT_MELEE_ATTACK_SWING_GESTURE || ACT_MELEE_ATTACK_SWING || ACT_GESTURE_MELEE_ATTACK_SWING )
	{
		...
		if (pBCC)
		{
			...
			CTakeDamageInfo info( this, this, 10.0, DMG_CLUB );
...
bool CNPC_Citizen::ShouldLookForBetterWeapon()
{
	if ( BaseClass::ShouldLookForBetterWeapon() )
	{
		...
		if( pWeapon )
		{
			...
			if( FClassnameIs( pWeapon, "weapon_m4" ) )
			{
			...
			else if( FClassnameIs( pWeapon, "weapon_doublebarrel" ) )
			{
				...
				if( NumWeaponsInSquad("weapon_doublebarrel") > 1 )
				{
...
#define CITIZEN_SCORCH_FLOOR	75
	...
	CHL2MP_Player *pAttacker = dynamic_cast<CHL2MP_Player*>( info.GetAttacker() );

	if ( pAttacker )
	{
		// S:O - Award players some money for their damage
		int m_iCurrentMoney = pAttacker->m_iMoney;
		pAttacker->m_iMoney = m_iCurrentMoney + info.GetDamage();
	}
...
void CNPC_Citizen::PainSound( const CTakeDamageInfo &info )
{
	...
	if ( FStrEq( pszCurrentModelName, "models/Humans/survivornpc1.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc2.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc3.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc4.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc5.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc6.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc8.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc9.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc10.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc11.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc12.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc13.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc14.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc15.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc16.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc17.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc18.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc19.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc20.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc21.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc22.mdl" ) ||
		 FStrEq( pszCurrentModelName, "models/Humans/survivornpc23.mdl" ) )
	{
		EmitSound( "Male.Pain" );
	}
	else if ( FStrEq( pszCurrentModelName, "models/Humans/survivornpc24.mdl" ) ||
			  FStrEq( pszCurrentModelName, "models/Humans/survivornpc25.mdl" ) ||
			  FStrEq( pszCurrentModelName, "models/Humans/survivornpc26.mdl" ) ||
			  FStrEq( pszCurrentModelName, "models/Humans/survivornpc27.mdl" ) ||
			  FStrEq( pszCurrentModelName, "models/Humans/survivornpc7.mdl" ) )
	{
		EmitSound( "Female.Pain" );
	}
	m_bWeAreInPain = false;
	}
}
...
//-----------------------------------------------------------------------------
void CNPC_Citizen::OnRangeAttack1()
{
	BaseClass::OnRangeAttack1();

	CWeaponSOBase *pWeapon = dynamic_cast< CWeaponSOBase* >( GetActiveWeapon() );

	// S:O - not all weapons call Operator_AnimEvent, so a weapon can force the NPC to fire.
	if( pWeapon && pWeapon->ShouldForceNPCFire() )
	{
		...
		pWeapon->FireNPCPrimaryAttack( this, vecShootOrigin, vecShootDir );
	}
...
void CNPC_Citizen::Event_Killed( const CTakeDamageInfo &info )
{
	...
	{
		CHL2MP_Player *pAttacker = dynamic_cast<CHL2MP_Player*>(pEnt);

		if ( pAttacker )
		{
			pAttacker->IncrementFragCount(1);

			// Award the player some experience.
			pAttacker->AddXP(3);

			GetGlobalTeam( pAttacker->GetTeamNumber() )->AddScore( 1 );
		}
	}
