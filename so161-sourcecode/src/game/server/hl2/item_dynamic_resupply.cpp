...
{
	{ "item_ammo_pistol",			"9mm",		SIZE_AMMO_PISTOL,		0.5f },
	{ "item_ammo_smg1",				"MP5K",			SIZE_AMMO_SMG1,			0.4f },
	...
	{ "item_ammo_357",				"Deagle",		SIZE_AMMO_357,			0.0f },
	{ "item_ammo_crossbow",			"Sniper",		SIZE_AMMO_CROSSBOW,		0.0f },
...
{
	// spawn gear for the nearest player // AI Patch Addition.
	CBasePlayer *pNearest = UTIL_GetNearestPlayer(GetAbsOrigin()); // AI Patch Addition.
	if ( pNearest != NULL ) // AI Patch Addition.
		SpawnDynamicItem( pNearest ); // AI Patch Addition.
}
