...
#include "zms/buymenu_new.h"
#include "zms/buymenu_new_mil.h"
...
// S:O - Modified to support buymenu and other stuff.
void CBaseViewport::CreateDefaultPanels( void )
{
	...
	AddNewPanel( CreatePanelByName( PANEL_BUYMIL ), "PANEL_BUYMIL" );
#endif
}
...
IViewPortPanel* CBaseViewport::CreatePanelByName(const char *szPanelName)
{
	...
	{
		newpanel = new CBuyMenuNew( this );
	}
	else if ( Q_strcmp(PANEL_BUYMIL, szPanelName) == 0 )
	{
		newpanel = new CBuyMenuNewMil( this );
	}
