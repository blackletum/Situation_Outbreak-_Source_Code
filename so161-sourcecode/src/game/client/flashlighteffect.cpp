...
static ConVar r_flashlightfov( "r_flashlightfov", "60.0", FCVAR_CHEAT );	// S:O - Flashlight (was 45.0)
...
static ConVar r_flashlightnear( "r_flashlightnear", "1.0", FCVAR_CHEAT );	// S:O - Flashlight (was 4.0)
static ConVar r_flashlightfar( "r_flashlightfar", "1000.0", FCVAR_CHEAT );	// S:O - Flashlight (was 750.0)
...
void CFlashlightEffect::UpdateLightNew(const Vector &vecPos, const Vector &vecForward, const Vector &vecRight, const Vector &vecUp )
{
	...
	state.m_bEnableShadows = false; //r_flashlightdepthtexture.GetBool();	// S:O - Flashlight shadows: attempt to save some FPS by removing them
