...
// S:O - Color alterations based on team colors.
Color g_ColorOrange( 210, 105, 30, 255 );
Color g_ColorBlue( 0, 204, 0, 255 );	// actually green (used by Zombies)
Color g_ColorRed( 208, 208, 208, 255 );	// actually white-ish gray (used by Survivors)
Color g_ColorGreen( 153, 255, 153, 255 );
Color g_ColorDarkGreen( 64, 255, 64, 255 );

// This is actually WHITE now. Remember that!
//Color g_ColorYellow( 255, 178.5, 0.0, 255 );
Color g_ColorYellow( 255, 255, 255, 255 );	// changed to make overall chat color white instead of yellow (looks better)
