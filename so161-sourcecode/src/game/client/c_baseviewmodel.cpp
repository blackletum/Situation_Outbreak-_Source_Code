...
// S:O - This is a little hack I whipped up to get our "flashlight on weapon attachement" function in c_baseplayer to work.
// For whatever reason, it wasn't calling the function below this one correctly, so I simply copied it and renamed the copy to this. lawl
