...
static ConVar  cl_interp_npcs( "cl_interp_npcs", "0.3", FCVAR_USERINFO, "Interpolate NPC positions starting this many seconds in past (or cl_interp, if greater)" ); // // AI Patch Addition.
...
BEGIN_RECV_TABLE_NOBASE(C_BaseEntity, DT_BaseEntity)
	...
	// S:O - Network NPC Health and NPC MaxHealth
...
// S:O - Modified for nightvision support
