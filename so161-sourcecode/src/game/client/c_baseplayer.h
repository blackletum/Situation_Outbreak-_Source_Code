...
public:
	...
	// S:O - Now that we've networked m_iMaxHealth, we can use this function (finally).
	...
	// S:O - NOTE: Override found in c_hl2mp_player.cpp...
...
public:
	...
	CNetworkVar(int,	version);	// TODO: For the last goddamn time, DO WE NEED THIS OR NOT!?
