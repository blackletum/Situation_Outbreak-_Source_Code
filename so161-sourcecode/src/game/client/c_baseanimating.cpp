...
{
	// S:O - Muzzleflash dyanmic lighting: too expensive - for now
	...
	if ( muzzleflash_light.GetBool() )
	{
		...
		{
			// S:O - Original Valve muzzleflash lighting
			//Vector vAttachment;
			//QAngle dummyAngles;
			...
			// S:O - New, purty muzzleflash lighting (probably a bit expensive to render, but eh, whatever)
