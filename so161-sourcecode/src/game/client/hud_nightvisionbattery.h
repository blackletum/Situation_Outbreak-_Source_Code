...
// $NoKeywords: $
//=============================================================================//
#if !defined( HUD_NIGHTVISIONPOWER_H )
#define HUD_NIGHTVISIONPOWER_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CHudNightvisionPower : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHudNightvisionPower, vgui::Panel );

public:
	CHudNightvisionPower( const char *pElementName );
...
private:
	...
	bool m_bPowerWasLow;
	float m_fNightvisionPower;
	float m_flSuitPower;
	float m_flSuitPowerOld;
};	

#endif // HUD_NIGHTVISIONPOWER_H