...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSOTextWindow::CSOTextWindow(IViewPort *pViewPort) : CTextWindow( pViewPort )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CSOTextWindow::SetVisible(bool state)
{
...
//-----------------------------------------------------------------------------
void CSOTextWindow::ShowPanel(bool bShow)
{
	if ( bShow )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CSOTextWindow::OnKeyCodePressed(KeyCode code)
{
...
//-----------------------------------------------------------------------------
void CSOTextWindow::PaintBackground()
{
}
...
//-----------------------------------------------------------------------------
void CSOTextWindow::PerformLayout()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CSOTextWindow::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	BaseClass::ApplySchemeSettings( pScheme );
	ApplyBackgroundSchemeSettings( this, pScheme );
}

CSOSpectatorGUI::CSOSpectatorGUI(IViewPort *pViewPort) : CSpectatorGUI(pViewPort)
{
}


bool CSOSpectatorGUI::NeedsUpdate( void )
{
