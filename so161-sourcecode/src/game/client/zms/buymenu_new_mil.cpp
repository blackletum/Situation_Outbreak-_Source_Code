...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CBuyMenuNewMil::CBuyMenuNewMil(IViewPort *pViewPort) : Frame(NULL, PANEL_BUYMIL)
{
	...
	LoadControlSettings("Resource/UI/MainBuyMenu_Military.res");

	m_pPanel = new EditablePanel( this, "buymenunew_mil" );
}

//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CBuyMenuNewMil::CBuyMenuNewMil(IViewPort *pViewPort, const char *panelName) : Frame(NULL, panelName)
{
	m_pViewPort = pViewPort;
	m_iScoreBoardKey = BUTTON_CODE_INVALID; // this is looked up in Activate()
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CBuyMenuNewMil::~CBuyMenuNewMil()
{
}

Panel *CBuyMenuNewMil::CreateControlByName(const char *controlName)
{
...
void CBuyMenuNewMil::UpdateShownWeaponModel( int buttonToRead )
{
...
const char *CBuyMenuNewMil::GetWeaponFromButton( int buttonToRead )
{
	...
	case 4:
		return "models/weapons/w_as50.mdl";
	case 5:
...
//-----------------------------------------------------------------------------
void CBuyMenuNewMil::OnCommand( const char *command )
{
...
//-----------------------------------------------------------------------------
void CBuyMenuNewMil::ShowPanel(bool bShow)
{
	if ( bShow )
	{
		Activate();
...
void CBuyMenuNewMil::SetData(KeyValues *data)
{
}
...
//-----------------------------------------------------------------------------
void CBuyMenuNewMil::SetLabelText(const char *textEntryName, const char *text)
{
...
//-----------------------------------------------------------------------------
void CBuyMenuNewMil::SetVisibleButton(const char *textEntryName, bool state)
{
...
void CBuyMenuNewMil::OnKeyCodePressed(KeyCode code)
{
