...
#ifndef CLIENT_DLL
ConVar sk_weapon_ak47_alt_fire_radius( "sk_weapon_ak47_alt_fire_radius", "10" );
ConVar sk_weapon_ak47_alt_fire_duration( "sk_weapon_ak47_alt_fire_duration", "4" );
ConVar sk_weapon_ak47_alt_fire_mass( "sk_weapon_ak47_alt_fire_mass", "150" );
#endif
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAK47::DelayedAttack( void )
{
	...
	CreateCombineBall(	vecSrc, 
						vecVelocity, 
						sk_weapon_ak47_alt_fire_radius.GetFloat(), 
						sk_weapon_ak47_alt_fire_mass.GetFloat(),
						sk_weapon_ak47_alt_fire_duration.GetFloat(),
						pOwner );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAK47::FireNPCSecondaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
	/*WeaponSound( WPN_DOUBLE );
	...
	float flDuration = RemapValClamped( flAmmoRatio, 0.0f, 1.0f, 0.5f, sk_weapon_ak47_alt_fire_duration.GetFloat() );
	float flRadius = RemapValClamped( flAmmoRatio, 0.0f, 1.0f, 4.0f, sk_weapon_ak47_alt_fire_radius.GetFloat() );
...
{
	#define	EASY_DAMPEN			10.5f
	#define	MAX_VERTICAL_KICK	50.0f	//Degrees
