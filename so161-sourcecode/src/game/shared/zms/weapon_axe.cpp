...
// I like axes! lawlalawlawlwlwalwalwalawllwalw
...
void CWeaponAxe::ItemPostFrame( void )
{
...
//-----------------------------------------------------------------------------
void CWeaponAxe::AddViewKickSecondary( void )
{
...
void CWeaponAxe::Hit(trace_t &traceHit)
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
