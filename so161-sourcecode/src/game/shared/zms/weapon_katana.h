...
#ifndef HL2MP_WEAPON_KATANA_H
#define HL2MP_WEAPON_KATANA_H
#pragma once
...
class CWeaponKatana : public CBaseHL2MPBludgeonWeapon
{
public:
	DECLARE_CLASS( CWeaponKatana, CBaseHL2MPBludgeonWeapon );
...
//#endif
	...
	float		GetRange( void )		{	return	80.0f;	}
