...
//-----------------------------------------------------------------------------
void CWeaponKatana::AddViewKickSecondary( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponKatana::Drop( const Vector &vecVelocity )
{
#ifndef CLIENT_DLL
...
void CWeaponKatana::Hit(trace_t &traceHit)
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
...
void CWeaponKatana::SecondaryAttack()
{
#ifndef CLIENT_DLL
