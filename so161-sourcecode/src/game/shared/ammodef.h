...
public:
	...
	// S:O - Modified to allow convars for default NPC damage values.
	// This really makes the entire function much more flexible and interesting.
	...
	// ^^^ S:O - End of Modification (ONLY THE ABOVE FUNCTION AND FUNCTION DECLARATION WAS MODIFIED HERE) ^^^
