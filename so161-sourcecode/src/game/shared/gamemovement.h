...
#define GAMEMOVEMENT_JUMP_TIME				656.0f	// S:O - Modified - PREVIOUS: 510.0f	//ms approx - based on the 21 unit height jump - normally 510.0f
#define GAMEMOVEMENT_JUMP_HEIGHT			35.0f	// S:O - Modified - PREVIOUS: 45.0f	//ModificationMovement Addition: Original is 21.0f units

#define GAMEMOVEMENT_JUMP_TIME_REAPER		4686.0f	// S:O - Modified jump time for reapers ONLY (unused/broken??)
#define GAMEMOVEMENT_JUMP_HEIGHT_REAPER		500.0f	// S:O - Modified jump height for reapers ONLY (maximum)
#define GAMEMOVEMENT_JUMP_DISTANCE_REAPER	500.0f	// S:O - Modified jump distance for reapers ONLY (maximum)
...
//private:
	...
	float GAMEMOVEMENT_JUMP_DELAY_REAPER;	// S:O - The amount of time a reaper will have to wait before they can super-jump again (in ms)
