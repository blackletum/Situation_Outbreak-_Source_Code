...
// S:O - Dynamic falldamage functionality (modified)
#define DAMAGE_FOR_FALL_SPEED		500.0f / ( PLAYER_FATAL_FALL_SPEED - PLAYER_MAX_SAFE_FALL_SPEED ) // damage per unit per second.
...
// S:O - Override default colors with mod ones in case we missed anything.
// basic team colors
#define COLOR_RED			Color(0, 204, 0, 255)		//def: Color(255, 64, 64, 255)
#define COLOR_BLUE			Color(208, 208, 208, 255)	//def: Color(153, 204, 255, 255)
#define COLOR_YELLOW		Color(255, 255, 255, 255)	//def: Color(255, 178, 0, 255)
#define COLOR_GREEN			Color(153, 255, 153, 255)
#define COLOR_GREY			Color(204, 204, 204, 255)

// S:O - Additional Defines
#define GE_LUA 1
#define COLOR_ORANGE		Color(210, 105, 30, 255)
#define COLOR_HUMANS		Color(208, 208, 208, 255)
#define COLOR_ZOMBIES		Color(0, 204, 0, 255)
#define COLOR_MILITARY		Color(210, 105, 30, 255)
#define COLOR_UNASSIGNED	Color(255, 255, 255, 255)
#define ZMS_CVERSION 0		// Currently not working, setting to 0.
#define ZMS_SVERSION 0		// Currently not working, setting to 0.
