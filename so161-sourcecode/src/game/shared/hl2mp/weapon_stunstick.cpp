...
#ifdef CLIENT_DLL
#define CWeaponStunStick C_WeaponStunStick //AI Patch Addition
#endif
...
acttable_t	CWeaponStunStick::m_acttable[] = 
{
	...
	{ ACT_IDLE_ANGRY,		ACT_IDLE_ANGRY_MELEE,	true }, //AI Patch Addition
};
	...
	switch( pEvent->event )
	{
		case EVENT_WEAPON_MELEE_HIT:
		{
			...
			if ( pHurt )
			{
				...
				CNPC_MetroPolice *pCop = dynamic_cast<CNPC_MetroPolice *>(pOperator); //AI Patch Addition
...
BaseClass::Drop( vecVelocity ); //AI Patch Addition
