...
public:
	...
	{		
	// Handle NPCs first //AI Patch Addition
		static Vector npcCone = VECTOR_CONE_5DEGREES; //AI Patch Addition
		if ( GetOwner() && GetOwner()->IsNPC() ) //AI Patch Addition
			return npcCone; //AI Patch Addition
		static Vector cone;
...
void CWeaponPistol::PrimaryAttack( void )
{
	...
	#ifndef CLIENT_DLL //AI Patch Addition
	CSoundEnt::InsertSound( SOUND_COMBAT, GetAbsOrigin(), SOUNDENT_VOLUME_PISTOL, 0.2, GetOwner() ); //AI Patch Addition
#endif //AI Patch Addition
