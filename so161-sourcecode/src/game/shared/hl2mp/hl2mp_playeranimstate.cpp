...
void CHL2MPPlayerAnimState::DoAnimationEvent( PlayerAnimEvent_t event, int nData )
{
	...
	{
		// S:O - Default to ACT_WALK instead of ACT_INVALID, just in case we're caught between an animation or something.
		iGestureActivity = ACT_WALK;
...
void CHL2MPPlayerAnimState::ComputePoseParam_MoveYaw( CStudioHdr *pStudioHdr )
{
	...
	// S:O - Attempt to fix the strange-looking walking and running animation problems.
