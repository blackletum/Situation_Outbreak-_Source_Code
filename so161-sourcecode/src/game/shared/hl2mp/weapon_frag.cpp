...
public:
	...
	bool	ShouldDisplayHUDHint() { return true; } //AI Patch Addition.
...
{
{ ACT_RANGE_ATTACK1, ACT_RANGE_ATTACK_SLAM, true }, //AI Patch Addition.
...
//	vForward[0] += 0.1f;
	...
	CBaseGrenade *pGrenade = Fraggrenade_Create( vecSrc, vec3_angle, vecThrow, AngularImpulse(600,random->RandomInt(-1200,1200),0), pPlayer, GRENADE_TIMER, false, false );
...
void CWeaponFrag::LobGrenade( CBasePlayer *pPlayer )
{
	...
	CBaseGrenade *pGrenade = Fraggrenade_Create( vecSrc, vec3_angle, vecThrow, AngularImpulse(200,random->RandomInt(-600,600),0), pPlayer, GRENADE_TIMER, false, false );
...
void CWeaponFrag::RollGrenade( CBasePlayer *pPlayer )
{
	...
	CBaseGrenade *pGrenade = Fraggrenade_Create( vecSrc, orientation, vecThrow, rotSpeed, pPlayer, GRENADE_TIMER, false, false );
...
//-----------------------------------------------------------------------------
bool CWeaponFrag::ReloadOrSwitchWeapons( void )
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
	Assert( pOwner );
...
#ifndef CLIENT_DLL
			UTIL_Remove(this);
			// S:O - We should always have a pair of these on us anyway, so switch to them
