...
// S:O - Team-specific ladders
int CFuncLadder::GetTeamNumber( void )
{
	return m_iTeamSpecific;
}
...
LINK_ENTITY_TO_CLASS( meowmix, CFuncLadder );
...
BEGIN_DATADESC( CFuncLadder )
	...
	// S:O - Team-specific ladders
	DEFINE_KEYFIELD( m_iTeamSpecific, FIELD_INTEGER, "TeamSpecific" ),
