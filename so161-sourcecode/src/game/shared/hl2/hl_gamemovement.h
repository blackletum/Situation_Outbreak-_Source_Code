...
public:
	...
	// S:O - func_ladder support
	// TODO: Is it true that this should be commented out? Does this break anything?
	// Overrides

	// S:O - We still require this check to ensure spectators don't climb ladders
