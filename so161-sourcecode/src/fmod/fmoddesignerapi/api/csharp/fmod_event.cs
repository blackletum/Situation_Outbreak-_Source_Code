...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00042802;
#if WIN64
    ...
    */
    public struct EVENT_SOUNDDEFINFO //PAS - check this!
    {
    ...
    */
    public class EventReverb
    {
        ...
        public RESULT setProperties      (ref REVERB_PROPERTIES prop)
        {
            return FMOD_EventReverb_SetProperties(eventreverbraw, ref prop);
        }
        public RESULT getProperties      (ref REVERB_PROPERTIES prop)
        {
            return FMOD_EventReverb_GetProperties(eventreverbraw, ref prop);
        }
        ...
        [DllImport (EVENT_VERSION.dll)]
        private static extern RESULT FMOD_EventReverb_SetProperties     (IntPtr eventreverb, ref REVERB_PROPERTIES prop);
        [DllImport (EVENT_VERSION.dll)]
        private static extern RESULT FMOD_EventReverb_GetProperties     (IntPtr eventreverb, ref REVERB_PROPERTIES prop);
        [DllImport (EVENT_VERSION.dll)]
    ...
    */
    public class MusicSystem
    {
        ...
        public RESULT setReverbProperties(ref REVERB_CHANNELPROPERTIES prop)
        {
            return FMOD_MusicSystem_GetReverbProperties(musicsystemraw, ref prop);
        }
        public RESULT getReverbProperties(ref REVERB_CHANNELPROPERTIES prop)
        {
            return FMOD_MusicSystem_GetReverbProperties(musicsystemraw, ref prop);
        ...
        public RESULT getMemoryInfo      (uint memorybits, uint event_memorybits, ref uint memoryused, IntPtr memoryused_array)
        {
            return FMOD_MusicSystem_GetMemoryInfo(musicsystemraw, memorybits, event_memorybits, ref memoryused, memoryused_array);
        }
        ...
        [DllImport(EVENT_VERSION.dll)]
        private static extern RESULT FMOD_MusicSystem_SetReverbProperties   (IntPtr musicsystem, ref REVERB_CHANNELPROPERTIES prop);
        [DllImport(EVENT_VERSION.dll)]
        private static extern RESULT FMOD_MusicSystem_GetReverbProperties   (IntPtr musicsystem, ref REVERB_CHANNELPROPERTIES prop);
        [DllImport(EVENT_VERSION.dll)]
        ...
        [DllImport (EVENT_VERSION.dll)]
        private static extern RESULT FMOD_MusicSystem_GetMemoryInfo         (IntPtr musicsystem, uint memorybits, uint event_memorybits, ref uint memoryused, IntPtr memoryused_array);
    ...
    */
    public class MusicPrompt
    {
        ...
        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, IntPtr memoryused_array)
        {
            return FMOD_MusicPrompt_GetMemoryInfo(musicpromptraw, memorybits, event_memorybits, ref memoryused, memoryused_array);
        }
        ...
        [DllImport (EVENT_VERSION.dll)]
        private static extern RESULT FMOD_MusicPrompt_GetMemoryInfo     (IntPtr musicprompt, uint memorybits, uint event_memorybits, ref uint memoryused, IntPtr memoryused_array);
