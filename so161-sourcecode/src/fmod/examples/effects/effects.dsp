...
!MESSAGE 
!MESSAGE NMAKE /f "effects.mak" CFG="effects - Win32 Release C"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "effects - Win32 Release C" (based on "Win32 (x86) Console Application")
...
!MESSAGE "effects - Win32 Debug C" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "effects - Win32 Release C"
...
# ADD BSC32 /nologo
LINK32=cwlink.exe
# ADD BASE LINK32 wsock32.lib winmm.lib ole32.lib user32.lib msacm32.lib /nologo /subsystem:console /machine:I386 /out:"effects.exe"
# SUBTRACT BASE LINK32 /incremental:yes /map
# ADD LINK32 ../../api/lib/fmodex_vc.lib /nologo /subsystem:console /machine:I386 /out:"effects.exe"
...
!ELSEIF  "$(CFG)" == "effects - Win32 Release"
...
# ADD BSC32 /nologo
LINK32=cwlink.exe
# ADD BASE LINK32 ../../api/lib/fmod4vc.lib /nologo /subsystem:console /machine:I386 /out:"effects.exe"
# SUBTRACT BASE LINK32 /incremental:yes /map
# ADD LINK32 ../../api/lib/fmodex_vc.lib /nologo /subsystem:console /debug /machine:I386 /out:"effects.exe"
# SUBTRACT LINK32 /incremental:yes /map
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy ..\..\api\fmodex.dll .
...
!ELSEIF  "$(CFG)" == "effects - Win32 Debug C"
...
# Name "effects - Win32 Release C"
# Name "effects - Win32 Release"
# Name "effects - Win32 Debug"
# Name "effects - Win32 Debug C"
# Begin Source File
