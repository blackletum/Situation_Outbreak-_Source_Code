...
struct Plugin
{
    ...
    int         configheight;
    bool        configactive;
    PluginParam *param;      // hopefully there are no more than 64 parameters in a plugin!
};
    ...
    */
    {
        ...
        plugin->param = new PluginParam[plugin->numparams];
        memset(plugin->param, 0, sizeof(PluginParam) * plugin->numparams);
