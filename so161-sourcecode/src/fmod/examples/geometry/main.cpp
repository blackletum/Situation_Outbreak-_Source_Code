...
void init(void)
{
    ...
    printf("==================================================================\n");
    printf("Geometry example.  Copyright (c) Firelight Technologies 2004-2009.\n");
    printf("==================================================================\n\n");
    ...
    */
    ...
    result = fmodSystem->init(100, FMOD_INIT_3D_RIGHTHANDED | FMOD_INIT_SOFTWARE_OCCLUSION | FMOD_INIT_SOFTWARE_HRTF | FMOD_INIT_GEOMETRY_USECLOSEST, 0);
    if (result == FMOD_ERR_OUTPUT_CREATEBUFFER)         /* Ok, the speaker mode selected isn't supported by this soundcard.  Switch it back to stereo... */
    {
        result = fmodSystem->setSpeakerMode(FMOD_SPEAKERMODE_STEREO);
        ERRCHECK(result);
                
        result = fmodSystem->init(100, FMOD_INIT_3D_RIGHTHANDED | FMOD_INIT_SOFTWARE_OCCLUSION | FMOD_INIT_SOFTWARE_HRTF | FMOD_INIT_GEOMETRY_USECLOSEST, 0);/* ... and re-init. */
        ERRCHECK(result);
    };
