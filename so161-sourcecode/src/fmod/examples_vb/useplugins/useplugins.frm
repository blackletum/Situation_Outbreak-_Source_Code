...
Private Sub Form_Load()
    ...
    For count = 0 To Numplugins - 1
        ...
        result = FMOD_System_GetPluginInfo(system, handle, 0, pluginname(0), 256, 0)
        ERRCHECK (result)
...
break:
    ...
    If Not initialised Then
        result = FMOD_System_GetPluginHandle(system, FMOD_PLUGINTYPE_OUTPUT, selectedplugin, handle)
        ERRCHECK (result)
